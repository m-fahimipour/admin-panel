                    ...
                    <section className="container-information">
                        ...
                        <div className="body-information">
                            ...
                            <div className="information">
                                ...
                                <div className="item"><span>Country: </span>Iran</div>
                            </div>
                        </div>
                        <span className="edit">Edit</span>
                    </section>
                </Grid>
                <Grid item xs={12} md={6} lg={8} marginTop={{xs:"0.75rem", md:"0"}}><Chart height={230} title="User Spending ( Last 5 Month )"/></Grid>
            </Grid>
            <Grid item xs={12}>
                <ListTransactions title="Last Orders" customer={false}/>
            </Grid>
        </Grid>
    )
}