                ...
                <Grid className="wrapper-create-new" container columns={12}>
                    ...
                    <Grid className="right" container item xs={12} md={8}>
                        <Grid className="left-side-form" flexDirection="column" item xs={12} md={6}>
                            ...
                            {inNewuserLocation ? <div className="item"><label>Address: </label><input type="text" placeholder=" St. Pahlavi Tajrish Tehran" /></div> : null}
                        ...
                        <Grid className="right-side-form"item xs={12} md={6}>
                            ...
                            {inNewuserLocation ? <div className="item"><label>Country: </label><input type="text" placeholder=" Iran" /></div> : null}
                        </Grid>
